...
public class PicoVRManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        PVRPluginEvent.PVR_RenderEditorInitializeLegacy();
    #else
        PVRPluginEvent.PVR_RenderEditorInitialize();
    #endif
#endif
        if (sdk == null)
        {
        ...
        Debug.Log("DeviceType: " + DeviceType + "  Separation:" + picoVRProfile.device.devLenses.separation.ToString());
        inPicovr = false;
        newInPicovr = true;
        eyeFov = 90.0f;
        pvrNeck = true;
...
#if UNITY_EDITOR_WIN
    #if (UNITY_5_0 || UNITY_5_1 || UNITY_4_6 || UNITY_4_7)
        PVRPluginEvent.PVR_RenderEditorShutDownLegacy();
    #else
        PVRPluginEvent.PVR_RenderEditorShutDown();
    #endif
        PVRPluginEvent.PVR_Shutdown();
#endif
    }
